...
Finally, the matrix obtained as a transformation for $q_0$ can be rewritten as $$\rmat{1 & 0 \\ 0 & e^{i\alpha}} = e^{i \alpha/2} R_z(\alpha)$$ meaning it is just a $z$-axis rotation up to a global phase --- which can be usually dropped.
