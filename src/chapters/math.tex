    ...
    \begin{enumerate}
        \item Let $A$ be a Hermitian operator, and let $v$ be an eigenvector of $A$ associated to an eigenvalue $\lambda$; then, we have that
            \begin{equation*}
                ...
                \end{alignedat}
            \end{equation*}
            Now, since $v$ is an eigenvector we know that $v \neq 0$, this implies that $\braket{v|v} \neq 0$, hence we conclude that $$\lambda \braket{v|v} = \overline \lambda \braket{v|v} \iff \lambda = \overline \lambda$$
