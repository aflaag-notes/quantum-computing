...
\begin{framedalgo}{Deutsch algorithm}
    ...
    \begin{algorithmic}[1]
        \Function{Deutsch}{$f$, $q_0$, $q_1$}
            \State $q_1 \takes X(q_1)$
            \State $q_0, q_1 \takes (H \otimes H)(q_0, q_1)$
            \State $q_0, q_1 \takes U_f(q_0, q_1)$
            \State $q_0 \takes H(q_0)$
...
\begin{framedalgo}{Deutsch-Josza algorithm}
    ...
    \begin{algorithmic}[1]
        \Function{DeutschJosza}{$f$, $q_0$, $q_1$}
            \State $q_1 \takes X(q_1)$
            \State $q_0, q_1 \takes (H^{\otimes n} \otimes H)(q_0, q_1)$
            \State $q_0, q_1 \takes U_f(q_0, q_1)$
            \State $q_0 \takes H^{\otimes n}(q_0)$
            \State \tbf{return} $\mbox{measure}(q_0)$
        \EndFunction
    \end{algorithmic}
\end{framedalgo}
