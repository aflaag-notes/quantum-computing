...
\begin{figure}[H]
	\[
		\Qcircuit @C=1em @R=1.5em {
                & \lstick{\ket{x_1}} & \gate H & \gate{R_2} & \qw \push{\cdots} \qw  & \gate{R_{n - 1}} & \gate{R_n} & \qw & \qw & \qw & \qw & \qw & \qw & \qw & \qw & \qw \\ 
                % & \lstick{\ket{x_2}} & \qw & \ctrl{-1} & \gate \ldots & \qw & \qw & \gate H & \gate \ldots & \gate{R_{n - 2}} & \gate{R_{n - 1}} & \qw & \qw & \qw & \qw& \qw \\ 
                % & \lstick{\vdots} & \vdots & \qw & \qw & \qw & \qw & \qw & \qw & \qw & \qw & \qw & \qw & \qw & \qw & \qw \\ 
                % & \lstick{\ket{x_{n - 1}}} & \qw & \qw & \qw & \ctrl{-3} & \qw & \qw & \qw & \ctrl{-2} & \qw & \gate \ldots & \gate H & \gate{R_2} & \qw & \qw \\ 
		}
	\]
	% \caption{The circuit.}
\end{figure}
