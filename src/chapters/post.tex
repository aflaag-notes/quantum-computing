...
\begin{equation*}
	...
	\end{alignedat}
\end{equation*}
Similarly, we get that $\rho^B = \sigma$. For the general case, if we assume that $$\tau = \sum_{i = 1}^N p_1 \ket{\phi_i} \bra{\phi_i} \quad \quad \sigma = \sum_{i =1}^N q_i \ket{\psi_i}\bra {\psi_i}$$ then we get that
\begin{equation*}
	\begin{split}
		\rho^A & = \tr_B(\rho)                                                                                                               \\
		       & = \tr_B(\tau \otimes \sigma)                                                                                                \\
