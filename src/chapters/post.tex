...
\end{figure}
    ...
    \begin{equation*}
        \begin{split}
            ...
            = & \sum_{y \in \B^n} \alpha_{0y} \ket {0y} + \sum_{y \in \Bìn} \alpha_{1y} \ket 1 \otimes U \ket y \\ 
            \xrightarrow{\mathrm{measure}(\ket \psi_0)} & \ket \psi \soe{ll}{\sum_{y \in \B^n} \ket{0y} & @ \ \sum_{y \in \B^n} \abs{\alpha_{0y}}^2 \\ \sum_{y \in \B^n} \ket 1 \otimes U \ket{y} & @ \ \sum_{y \in \B^n} \abs{\alpha_{1y}}^2} \\
        \end{split}
    \end{equation*}
}
